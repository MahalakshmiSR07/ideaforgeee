"""
Django settings for ideaforge_project project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-v67x^u&d+5l@7sg=m5q9ph)o89aw_k6w0abd#1=3uyi9zj+@ze')
...
ROOT_URLCONF = 'ideaforge_project.urls'
...
WSGI_APPLICATION = 'ideaforge_project.wsgi.application'
